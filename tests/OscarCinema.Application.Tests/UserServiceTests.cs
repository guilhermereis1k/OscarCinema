...
namespace OscarCinema.Application.Tests
{
        public class UserServiceTests
        {
            ...
            {
                var user = new User("Test User", "082.027.150-08", "test@email.com", UserRole.USER);
                var dto = new UserResponse { Id = 1, Name = "Test User", Email = "test@email.com", Role = UserRole.USER };

                _unitOfWorkMock
                    .Setup(u => u.UserRepository.GetByIdAsync(1))
                    .ReturnsAsync(user);
            ...
            {
                var existing = new User("Old Name", "079.924.480-57", "old@email.com", UserRole.USER);
                ...
                _unitOfWorkMock
                    .Setup(u => u.UserRepository.UpdateAsync(existing))
                ...
                _mapperMock
                    .Setup(m => m.Map<UserResponse>(existing))
            ...
            {
                var user = new User("Test User", "930.085.190-08", "test@email.com", UserRole.USER);
                ...
                _unitOfWorkMock
                    .Setup(u => u.UserRepository.DeleteAsync(1))
                    .Returns(Task.CompletedTask);
            ...
            {
                new User("User 1", "529.230.500-61", "user1@email.com", UserRole.ADMIN),
                new User("User 2", "099.541.330-46", "user2@email.com", UserRole.ADMIN)
            };
